...
const docs: Record<string, { title: string; content: string[] }> = {
  quickstart: {
    ...
    content: [
      ...
      '4. **Monitore os resultados** - Acompanhe pelo Dashboard em tempo real',
      '',
      '### Agentes Disponíveis',
      '- **Agenda**: Gerenciamento de compromissos e lembretes',
      '- **Clientes**: CRM completo com follow-up automático',
      '- **Contabilidade**: DAS, NFs, IRPF e todas as obrigações MEI',
